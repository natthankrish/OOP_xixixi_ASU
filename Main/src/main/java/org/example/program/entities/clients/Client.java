...
//    }
    ...
    public void setName(String name) {
        if (this.type instanceof Member mr) {
            mr.setName(name);
        } else if (this.type instanceof VIP vp) {
            vp.setName(name);
        }
    }
    ...
    public void setPhoneNumber(String num) {
        if (this.type instanceof Member mr) {
            mr.setPhoneNumber(num);
        } else if (this.type instanceof VIP vp) {
            vp.setPhoneNumber(num);
        }
    }
    ...
    public String getPhoneNumber() {
        if (this.type instanceof Member mr) {
            return mr.getPhoneNumber();
        } else if (this.type instanceof VIP vp) {
            return vp.getPhoneNumber();
        }
        return null;
    }
